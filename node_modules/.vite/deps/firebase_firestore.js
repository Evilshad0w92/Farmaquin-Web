import {
  ...
  isSafari,
  registerVersion
} from "./chunk-L3K5DPAW.js";
import "./chunk-RBWUD64Q.js";

// node_modules/firebase/node_modules/@firebase/webchannel-wrapper/dist/esm/index.esm2017.js
...
function ab(a, b2, c, d, e) {
  if (d && d.once) return bb(a, b2, c, d, e);
  if (Array.isArray(b2)) {
...
function db(a, b2, c, d, e, f) {
  ...
  d.src = a;
  d.listener = c;
  if (a.addEventListener) pa || (e = h), void 0 === e && (e = false), a.addEventListener(b2.toString(), d, e);
  else if (a.attachEvent) a.attachEvent(gb(b2.toString()), d);
...
function bb(a, b2, c, d, e) {
  if (Array.isArray(b2)) {
    for (var f = 0; f < b2.length; f++) bb(a, b2[f], c, d, e);
    return null;
  }
  c = cb(c);
...
function ib(a, b2, c, d, e) {
  if (Array.isArray(b2)) for (var f = 0; f < b2.length; f++) ib(a, b2[f], c, d, e);
  else (d = p(d) ? !!d.capture : !!d, c = cb(c), a && a[A]) ? (a = a.i, b2 = String(b2).toString(), b2 in a.g && (f = a.g[b2], c = Wa(f, c, d, e), -1 < c && (Qa(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b2], a.h--)))) : a && (a = eb(a)) && (b2 = a.g[b2.toString()], a = -1, b2 && (a = Wa(b2, c, d, e)), (c = -1 < a ? b2[a] : null) && jb(c));
}
function jb(a) {
  if ("number" !== typeof a && a && !a.fa) {
    var b2 = a.src;
    if (b2 && b2[A]) Xa(b2.i, a);
    else {
...
function C(a, b2) {
  ...
  e = lb(h, d, true, b2) && e;
  e = lb(h, d, false, b2) && e;
  if (c) for (f = 0; f < c.length; f++) h = b2.g = c[f], e = lb(h, d, false, b2) && e;
}
B.prototype.N = function() {
  ...
  if (this.i) {
    var a = this.i, c;
    for (c in a.g) {
      for (var d = a.g[c], e = 0; e < d.length; e++) Qa(d[e]);
      delete a.g[c];
      a.h--;
    }
  }
      ...
      if (!(3 > u) && (3 != u || ya || this.g && (this.h.h || this.g.ja() || oc(this.g)))) {
        ...
        if (this.i) {
          if (this.ba && !this.K) {
            ...
            if (c = n) D(this.j, this.m, c, "Initial handshake response via X-HTTP-Initial-Response"), this.K = true, sc(this, c);
            else {
              this.i = false;
              this.o = 3;
              F(12);
        ...
        } else 400 == c && 0 < h.indexOf("Unknown SID") ? (this.o = 3, F(12)) : (this.o = 0, F(13)), I(this), rc(this);
      }
    }
  } catch (u) {
  } finally {
...
function tc(a, b2, c) {
  let d = true, e;
  for (; !a.J && a.C < c.length; ) if (e = vc(a, c), e == hc) {
    ...
    if (0 != c.H && (c.g == a || yc(c.h, a))) {
      if (!a.K && yc(c.h, a) && 3 == c.H) {
        ...
        if (Array.isArray(d) && 3 == d.length) {
          ...
          if (0 == e[0]) a: {
            if (!c.u) {
              if (c.g) if (c.g.G + 3e3 < a.G) zc(c), Ac(c);
              else break a;
              Bc(c);
              F(18);
            }
          }
          else c.Fa = e[1], 0 < c.Fa - c.V && 37500 > e[2] && c.M && 0 == c.A && !c.v && (c.v = Tb(q(c.ib, c), 6e3));
          if (1 >= Cc(c.h) && c.na) {
            try {
              c.na();
            } catch (n) {
      ...
      } else if ((a.K || c.g == a) && zc(c), !qa(b2)) for (e = c.Ja.g.parse(b2), b2 = 0; b2 < e.length; b2++) {
        let n = e[b2];
        c.V = n[0];
        n = n[1];
        if (2 == c.H) if ("c" == n[0]) {
          ...
          0 < c.i.length && Hc(c);
        } else "stop" != n[0] && "close" != n[0] || J(c, 7);
        else 3 == c.H && ("stop" == n[0] || "close" == n[0] ? "stop" == n[0] ? J(c, 7) : Ic(c) : "noop" != n[0] && c.l && c.l.Aa(n), c.A = 0);
      }
    }
    Qb(4);
  } catch (n) {
...
function Lc(a, b2) {
  ...
  else for (var c = Kc(a), d = Jc(a), e = d.length, f = 0; f < e; f++) b2.call(void 0, d[f], c && c[f], a);
}
...
function M(a, b2) {
  ...
  if (a instanceof M) {
    ...
    Rc(this, c);
    this.o = a.o;
  } else a && (c = String(a).match(Mc)) ? (this.h = !!b2, Oc(this, c[1] || "", true), this.s = Sc(c[2] || ""), this.g = Sc(c[3] || "", true), Pc(this, c[4]), this.l = Sc(c[5] || "", true), Rc(this, c[6] || "", true), this.o = Sc(c[7] || "")) : (this.h = !!b2, this.i = new Qc(null, this.h));
}
M.prototype.toString = function() {
  var a = [], b2 = this.j;
  b2 && a.push(Tc(b2, Uc, true), ":");
  var c = this.g;
  if (c || "file" == b2) a.push("//"), (b2 = this.s) && a.push(Tc(b2, Uc, true), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.m, null != c && a.push(":", String(c));
  if (c = this.l) this.g && "/" != c.charAt(0) && a.push("/"), a.push(Tc(c, "/" == c.charAt(0) ? Vc : Wc, true));
...
k.Z = function(a) {
  N(this);
  let b2 = [];
  if ("string" === typeof a) bd(this, a) && (b2 = b2.concat(this.g.get(O(this, a))));
  else {
...
md.prototype.i = /* @__PURE__ */ function(a) {
  return function() {
    return a;
  };
}({});
...
k.open = function(a, b2) {
  if (this.readyState != od) throw this.abort(), Error("Error reopening a connection");
  this.C = a;
  this.B = b2;
  this.readyState = 1;
  pd(this);
...
k.$a = function(a) {
  if (this.g && (this.l = a, this.h || (this.status = this.l.status, this.statusText = this.l.statusText, this.h = a.headers, this.readyState = 2, pd(this)), this.g && (this.readyState = 3, pd(this), this.g))) if ("arraybuffer" === this.responseType) a.arrayBuffer().then(this.Ya.bind(this), this.ka.bind(this));
...
function Jd(a, b2) {
  if (Cc(a.h) >= a.h.j - (a.m ? 1 : 0)) return false;
  if (a.m) return a.i = b2.F.concat(a.i), true;
...
k.Na = function(a) {
  ...
  } else 3 == this.H && (a ? Md(this, a) : 0 == this.i.length || fd(this.h) || Md(this));
};
function Md(a, b2) {
  var c;
  b2 ? c = b2.m : c = a.W++;
  ...
  a: {
    ...
    for (; ; ) {
      ...
      for (let t = 0; t < c; t++) {
        ...
        const u = e[t].g;
        n -= f;
        if (0 > n) f = Math.max(0, e[t].h - 100), m = false;
        else try {
          jd(u, h, "req" + n + "_");
        } catch (L2) {
          d && d(u);
...
function uc(a, b2) {
  ...
  if (a.g == b2) {
    ...
    a.g = null;
    var d = 2;
  } else if (yc(a.h, b2)) c = b2.F, Fc(a.h, b2), d = 1;
  else return;
  if (0 != a.H) {
    if (a.ta = b2.aa, b2.i) if (1 == d) {
    ...
    else if (e = b2.o, 3 == e || 0 == e && 0 < a.ta || !(1 == d && Jd(a, b2) || 2 == d && Bc(a))) switch (c && 0 < c.length && (b2 = a.h, b2.i = b2.i.concat(c)), e) {
      case 1:
        J(a, 5);
        break;
      case 4:
...
function Id(a) {
  ...
  if (a.l) {
    const b2 = gd(a.h);
    if (0 != b2.length || 0 != a.i.length) oa(a.pa, b2), oa(a.pa, a.i), a.h.i.length = 0, na(a.i), a.i.length = 0;
    a.l.ya();
  }
}
function Ec(a, b2, c) {
  var d = c instanceof M ? G(c) : new M(c, void 0);
  if ("" != d.g) b2 && (d.g = b2 + "." + d.g), Pc(d, d.m);
  else {
    var e = l.location;
    d = e.protocol;
...
function nc(a, b2, c) {
  if (b2 && !a.I) throw Error("Can't create secondary domain capable XhrIo object.");
...
function Pd() {
  if (y && !(10 <= Number(Ka))) throw Error("Environmental error: no available transport.");
}
...
Q.prototype.u = function(a) {
  ...
  if ("string" === typeof a) {
    ...
    c.__data__ = a;
    a = c;
  } else this.v && (c = {}, c.__data__ = mb(a), a = c);
...
S.prototype.j = function(a, b2) {
  ...
  for (var c = b2 - this.blockSize, d = this.m, e = this.h, f = 0; f < b2; ) {
    if (0 == e) for (; f <= c; ) Td(this, a, f), f += this.blockSize;
...
function U(a) {
  ...
  if (0 > a) return W(U(-a));
  for (var b2 = [], c = 1, d = 0; a >= c; d++) b2[d] = a / c | 0, c *= Wd;
  return new T(b2, 0);
}
function Xd(a, b2) {
  ...
  if ("-" == a.charAt(0)) return W(Xd(a.substring(1), b2));
...
k.R = function(a) {
  ...
  if (0 > this.X(Zd) && 0 > a.X(Zd)) return U(this.ea() * a.ea());
...
function $d(a, b2) {
  ...
  if (Y(a)) return new ce(V, V);
  if (X(a)) return b2 = $d(W(a), b2), new ce(W(b2.g), W(b2.h));
  if (X(b2)) return b2 = $d(a, W(b2)), new ce(W(b2.g), b2.h);
  if (30 < a.g.length) {
    if (X(a) || X(b2)) throw Error("slowDivide_ only works with positive integers.");
    for (var c = Yd, d = b2; 0 >= d.X(a); ) c = de(c), d = de(d);
    var e = Z(c, 1), f = Z(d, 1);
    d = Z(d, 2);
    for (c = Z(c, 2); !Y(d); ) {
      var h = f.add(d);
...
var Or = class {
  ...
  tn(t) {
    ...
    if (void 0 !== this.Ze) {
      const t2 = n[s];
      if (!this.nn(this.Ze, t2) || !this.sn(this.Ye[i++], t2)) return false;
      ++s;
    }
    for (; s < n.length; ++s) {
      const t2 = n[s];
      if (i >= this.Ye.length || !this.sn(this.Ye[i++], t2)) return false;
    }
    return true;
  }
  en(t) {
